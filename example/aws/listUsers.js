        ...
        cognitoIdentityServiceProvider.listUsers(
            {
                ...
                PaginationToken: ''
            },
            (err, data) => {
                ...
                if (err instanceof Error) {
                    ...
                    const users = data.Users.map((u) => {
                        const subAttribute = u.Attributes.find((a) => a.Name === 'sub');
                        ...
                        return {
                            sub: (subAttribute !== undefined) ? subAttribute.Value : undefined,
                            username: u.Username,
